        ...
        <div class="row">
          ...
          <div class="col-9">
            <div class="tab-content" id="v-pills-tabContent">
                      ...
                      <tbody class="services-list">
                          ...
                          @foreach($services as $index => $service)
                              <tr>
                                  ...
                                  <td>
                                      <a href="/percetakan/services/info-layanan" class="btn btn-info btn-sm">Info</a>
                                      <a href="{{ url('/percetakan/services/' . $service->id . '/packets') }}" class="btn btn-success btn-sm">Paket</a>
                                      <button type="button" class="btn btn-danger btn-sm" id="show_modal_delete" data-toggle="modal" data-target="#exampleModal" data-id="{{ $service->id }}">Hapus</button>
                                  </td>
                              </tr>
                          @endforeach
              ...
              <div class="tab-pane fade" id="v-pills-riwayat" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
                ...
                <div class="card card-default card-freelancer-dashboard">
                  <div class="card-body">
                    ...
                    <div class="form-group"><label class="control-label fwsb">Nama Percetakan</label>
                      <div class="row">
                        <div class="col-sm-12">
                          <input class="form-control input-lg mb-20" type="text" value="Limatiga Printing" name="" id="" readonly>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-sm-12 mb-20">
                            <input class="form-control input-lg contact-number mb-20" placeholder="" type="text" value="Sukarame" name="" id="" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
